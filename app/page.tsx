...
export default function Page() {
  ...
  return (
    <main className="editor-shell">
      ...
      <footer className="site-footer"><p>Built by Shahriar Tanvir</p><p>Daffodil International University, SWE —<br />262-35-351@diu.edu.bd</p><p>Rakib khan</p><p>LLB - VIII, Department of Maritime Law and Policy</p><p>Bangladesh Maritime University</p><p>lawkib29@gmail.com</p></footer>
    </main>
  )
}
